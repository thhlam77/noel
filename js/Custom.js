...
function showSantaClaus()
{
    if (leftToRight == true)
    {
        leftToRight = false;
        endPos = $(window).width();
        $("img#santaClaus").attr("src", "https://i.imgur.com/yrG9xdO.gif");
    ...
    else
    {
        leftToRight = true;
        endPos = -390;
        $("img#santaClaus").attr("src", "https://i.imgur.com/P6iDSqI.gif");
...
particleImage.src = 'https://i.imgur.com/pijlSJd.png';
    ...
    $("#reindeer").click(function() {
        ...
        if (bShowLetter == false)
        {
            $('#reindeer').animate({
                ...
                $("img#reindeer").attr("src", "https://i.imgur.com/GqUUBaj.png");
        ...
        else
        {
            $('#reindeer').animate({
                ...
                $("img#reindeer").attr("src", "https://i.imgur.com/5GI8hop.png");
